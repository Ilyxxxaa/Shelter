function sliderActive(array) {
  ...
  slider.addEventListener('animationend', (e) => {
    //все, что происходит после конца анимации
    arrowLeft.addEventListener('click', moveLeft);
    arrowRight.addEventListener('click', moveRight);
    let newItem;
  ...
  function moveLeft() {
    //  функция , кот отвечает за передвижение слайдера влево , а после удаление со стрелки слушателя
  ...
  function moveRight() {
    //  функция , кот отвечает за передвижение слайдера вправо , а после удаление со стрелки слушателя
